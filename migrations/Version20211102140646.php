 ...
 */
final class Version20211102140646 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE posts ADD category_id INT DEFAULT NULL, ADD user_id INT DEFAULT NULL');
